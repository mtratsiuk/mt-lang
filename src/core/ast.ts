/* Generated by ast-codegen.ts, do not edit manually. */
...
export type ExprVisitor<T> = {
  ...
  visitMethodCallChain(value: MethodCallChain): T;
};
...
export class MethodCallChain extends Expr {
  constructor(
    public receiver: Expr,
    public calls: { target: Expr; args: Expr[] }[],
  ) {
    super();
  }

  accept<T>(visitor: ExprVisitor<T>): T {
    return visitor.visitMethodCallChain(this);
  }
}
